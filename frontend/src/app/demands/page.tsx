...
try {
setLoading(true);
// If the user is HR and viewAll=true, displays all demands.
// Otherwise, displays only the user's demands.
const endpoint = (user?.role === 'hr' && viewAll)
...
{user?.role === 'hr' && viewAll ? 'All Demands' : 'My Demands'} 
</h1> 
<p className="mt-2 text-gray-600 dark:text-gray-400"> 
{user?.role === 'hr' && viewAll 
? 'Manage all HR requests' 
