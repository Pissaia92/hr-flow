...
export default function QuickActions({ userRole }: QuickActionsProps) {
  const actions = [
    {
      ...
      title: 'See demands',
      description: 'Manage all demands'
    },
    {
      href: '/demands/new',
      icon: (
  ...
  if (userRole === 'hr') {
    actions.push({
      ...
      title: 'Reports',
      description: 'See complete reports'
    });
  }

  return (
    <div className="bg-white dark:bg-gray-800 shadow-xl rounded-2xl p-6 transition-all duration-300">
      <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-6">Fast Actions</h2>
